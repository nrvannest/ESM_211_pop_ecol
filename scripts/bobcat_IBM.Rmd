...
n0_exp <- 40 #Starting population size (state variable)
birth.average <- 1.01 # average number of new offspring from an individual in a population in the next time step
